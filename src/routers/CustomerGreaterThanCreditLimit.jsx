...
export default function CustomerGreaterThanCreditLimit() {
  ...
  const fetchCustomers = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${BASE_URL}/api/v1/customer/More_than/${limit}`);
      ...
      alert("Error fetching customers by credit limit.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h2 className="text-2xl font-bold mb-4">Customers with Credit Limit Greater Than</h2>
